  ...
  return (
    <Wrapper variant={"regular"}>
      ...
      <Text>
        ...
        FSoftware does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of FSoftware,its agents and/or affiliates. Comments reflect the
        views and opinions of the person who post their views and opinions. To
        the extent permitted by applicable laws, FSoftware shall not be liable
      ...
      <Text>
        FSoftware reserves the right to monitor all Comments and to remove any
      ...
      <UnorderedList as={"h3"} mt="10" mb="10">
        <ListItem>
      ...
      <Text>
        You hereby grant FSoftware a non-exclusive license to use, reproduce,
      ...
      <Text>
        ...
        the hyperlink compensates the absence of FSoftware; and (d) the link is
      ...
      <Text>
        ...
        e-mail to FSoftware. Please include your name, your organization name,
      ...
      <Text>
        No use of FSoftware's logo or other artwork will be allowed for linking
