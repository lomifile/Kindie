...
const PrivacyPolicy: React.FC<{}> = ({}) => {
  return (
    <Wrapper variant={"regular"}>
      ...
      <Text>
        Google is one of Link third-party vendor on our site. It also uses
      ...
      <Text>
        Request that Link business that collects Link consumer's personal data
        disclose the categories and specific pieces of personal data that Link
        business has collected about consumers.
      </Text>
      <Text>
        Request that Link business delete any personal data about the consumer
        that Link business has collected.
      </Text>
      <Text>
        Request that Link business that sells Link consumer's personal data, not
        sell the consumer's personal data.
      </Text>
      <Text>
        If you make Link request, we have one month to respond to you. If you
      ...
      <Text>
        ...
        personal data. We may charge you Link small fee for this service.
      </Text>
      <Text>
