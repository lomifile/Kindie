...
export class kindie1632473214459 implements MigrationInterface {
    name = 'kindie1632473214459'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "staff_members" ("userId" integer NOT NULL, "kindergardenId" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_b5bcfa806647fc5497ee22529a8" PRIMARY KEY ("userId", "kindergardenId"))`);
        await queryRunner.query(`ALTER TABLE "staff_members" DROP COLUMN "createdAt"`);
        await queryRunner.query(`ALTER TABLE "staff_members" ADD "createdAt" TIMESTAMP NOT NULL DEFAULT now()`);
        await queryRunner.query(`CREATE INDEX "IDX_e360dda42b3876dc5a856d44ca" ON "staff_members" ("userId") `);
        await queryRunner.query(`CREATE INDEX "IDX_49a3a8f84a9909ce1c6a2d8d13" ON "staff_members" ("kindergardenId") `);
        ...
        await queryRunner.query(`ALTER TABLE "children" ADD CONSTRAINT "FK_7266a5d62545eabd5d2debeeae9" FOREIGN KEY ("createdById") REFERENCES "user"("Id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "children" ADD CONSTRAINT "FK_f68e0ce70aa69c1052566b922b7" FOREIGN KEY ("updatedById") REFERENCES "user"("Id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "staff_members" ADD CONSTRAINT "FK_e360dda42b3876dc5a856d44ca4" FOREIGN KEY ("userId") REFERENCES "user"("Id") ON DELETE CASCADE ON UPDATE CASCADE`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "staff_members" DROP CONSTRAINT "FK_e360dda42b3876dc5a856d44ca4"`);
