  ...
  return (
    ...
    >
      <div className="mr-auto w-full xs:w-full md:w1/2 md:p-5 sm:w-full">
        ...
        <p className="text-xl mt-5 text-secondary">
        ...
        <Button className="flex flex-row items-center w-52 text-primary bg-secondary text-xl rounded-lg px-5 py-2.5 text-center mt-10">
          Get started <KindieArrow />
        </Button>
      </div>
      <div className="block w-1/2 ml-auto mb-0 xs:hidden lg:block sm:hidden xl:block md:hidden md:w-full md:ml-auto sm:ml-0 sm:mb-10 xs:mb-10 sm:w-full xs:w-full">
        <img src="/HeroSvg.svg" />
      </div>
    </div>
  );
