          ...
          <Table>
            <TableData
              ...
              header={[
                ...
                { name: "Surname", property: "Surname", sortable: true },
                { name: "BirthDate", property: "BirthDate", sortable: true },
                { name: "Gender", property: "Gender" },
              ]}
              renderItem={(data) => (
                <>
                  <td className="text-sm text-accent font-light px-6 py-4 whitespace-nowrap">
                    {data.Id}
                  </td>
                  <td className="text-sm text-accent font-light px-6 py-4 whitespace-nowrap">
                    {data.Name}
